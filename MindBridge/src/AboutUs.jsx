...
const AboutUs = () => {
  return (
    <div className="min-h-[91vh] px-6 py-16 bg-skin text-black flex items-center justify-center">
      <motion.div
      ...
      >
        ...
        <motion.p
          className="text-lg mb-6 text-black/90 leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <h2 className="text-xl font-semibold text-black mb-2">What We Do</h2>
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h2 className="text-xl font-semibold text-black mb-2">Smart Suggestions</h2>
            <p className="text-black/80">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h2 className="text-xl font-semibold text-black mb-2">Connect & Simulate</h2>
            <p className="text-black/80">
